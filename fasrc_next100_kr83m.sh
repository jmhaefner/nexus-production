...
INI_MACRO="/n/holyscratch01/guenette_lab/jmartinalbo/nexus.init.${SLURM_ARRAY_TASK_ID}.mac"
CFG_MACRO="/n/holyscratch01/guenette_lab/jmartinalbo/nexus.config.${SLURM_ARRAY_TASK_ID}.mac"
...
echo "/Geometry/Next100/EL_field 20. kilovolt/cm"               >> ${CFG_MACRO}
